                        ...
                        ?>
                            ...
                            ?></td>
                                    <td>
                                        ...
                                        ?>
                                        <a href="<?php echo $viewUrl; ?>" target="_blank" class="btn btn-primary">View</a>  <a href="<?php echo $closeUrl; ?>" target="_blank" class="btn btn-primary">Close</a> <a href="<?php echo $deleteUrl; ?>" target="_self" class="btn btn-danger"  onclick="return confirm('Are you sure to delete this annotation (<?php echo $item->annotation_id;  ?>)?')">Delete</a>
                                    </td>
                                </tr>
                        <?php
                                }
                        ...
                        ?>
                            ...
                            ?></td>
                                    <td>
                                        ...
                                        ?>
                                        <a href="<?php echo $reopenUrl; ?>" target="_blank" class="btn btn-primary">Reopen</a>
                                    </td>
                                </tr>
                        <?php
                                }
