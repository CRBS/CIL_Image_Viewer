<body>
    <div class="container-fluid">
        ...
        if(is_null($cpJson) || count($cpJson) == 0)
        {
            echo "\n<div class='row'>";
            echo "\n<div class='col-md-12'>";
            echo "\nYou don't have any closed annotation priority assigned to you yet.";
            echo "\n</div>";
            echo "\n</div>";
        }
        else 
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                    ...
                                    $reopenUrl = $base_url."/Annotation_priority/reopen_annotation_assignee/".$item->image_id."/".$item->annotation_id."?username=".$username."&token=".$token;
                                ?>
