...
<div class="container-fluid">
  <div class="row" style="height: 100%">
      ...
      <div class="col-md-2" style="height: 100%">
          <div class="row">
              <div class="col-md-12">
                  <a href="#" class="btn btn-primary" style="color: white; outline: currentcolor none medium;" onclick="recalculate_sp()">Re-calculate super pixels</a>
              </div>
              <div class="col-md-12" style="margin-top:10px;">  
                  <!-- <a href="/Super_pixel/get_overlays/<?php //echo $image_id; ?>" target="_self" class="btn btn-info" style="color: white; outline: currentcolor none medium;">Run</a> -->
                  <form action="/Super_pixel/get_overlays/<?php echo $image_id; ?>" method="POST" onsubmit="return validate_run()">
                     <button id="run_submit_id" name="run_submit_id" type="submit" value="Submit" class="btn btn-info" style="outline: currentcolor none medium;">Run</button>
                 </form>
              </div>
              <div class="col-md-12" style="margin-top:10px;">
                
                 <form action="/Super_pixel/clear/<?php echo $image_id; ?>" method="POST" onsubmit="return validate_clear()">
                     <button id="clear_submit_id" name="clear_submit_id" type="submit" value="Submit" class="btn btn-info" style="outline: currentcolor none medium;">Clear</button>
                 </form>
                  
              </div>
              
              <div class="col-md-12" style="margin-top:10px;" >
                  <a href="/Super_pixel/gen_mask/<?php echo $image_id; ?>" target="_blank" class="btn btn-info" style="color: white; outline: currentcolor none medium;">Download training data</a>
              </div>
...
<script>
    ...
    {
        document.getElementById('run_submit_id').disabled = true;
        return true;
    }
...
<script>
    ...
    var c_recalculate = '<a href="#" class="btn btn-primary" style="color:white" onclick="recalculate_sp()">Re-calculate super pixels</a>';
    var c_run = '<a href="<?php echo $base_url; ?>/Super_pixel/get_overlays/<?php echo $image_id; ?>" target="_self" class="btn btn-info" style="color:white">Run</a>';
    var c_clear = '<form action="/Super_pixel/clear/<?php echo $image_id; ?>" method="POST" onsubmit="return validate_clear()"><button id="clear_submit_id" name="clear_submit_id" type="submit"  value="Submit" class="btn btn-info" >Clear</button></form>';
    var c_download_training = '<a href="<?php echo $base_url; ?>/Super_pixel/gen_mask/<?php echo $image_id; ?>" target="_blank" class="btn btn-info" style="color:white">Download training data</a>';
    
    /*var command = L.control({position: 'topright'});
    command.onAdd = function (map) {
            var div = L.DomUtil.create('div', 'command');

            div.innerHTML = c_recalculate+'<br style="line-height: 10px"/>'+'<br style="line-height: 10px"/>'+
                    c_run+'<br style="line-height: 10px"/>'+'<br style="line-height: 10px"/>'+c_clear+
